...
url = 'https://djinni.co/jobs/?primary_keyword=Python&exp_level=1y&employment=remote'
...
@router.message(F.text == 'IT Робота')
async def cmd_start(message: Message):
    await message.answer("👋 Привіт! Я бот для пошуку вакансій з Djinni.co\n\n"
                        "Напишіть /jobs щоб отримати останні IT-вакансій у Полтаві")
